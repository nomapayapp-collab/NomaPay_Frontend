...
export function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex lg:w-64 lg:min-w-56 lg:flex-col lg:shrink-0 lg:h-screen lg:sticky lg:top-0 bg-surface-dark border-r border-border-dark px-5 py-6">
      <Logo variant="lockup-oscuro" className="w-32 h-auto mb-8 px-2" />
      ...
      {user?.alias && (
        <div className="mt-8">
          ...
          <div className="rounded-control border border-dashed border-border-dark p-3">
            <p className="text-[13.5px] font-semibold text-text-dark-primary truncate mb-2">{user.alias}</p>
      ...
      <div className="mt-auto pt-6">
        <button
          ...
          className="flex items-center gap-3 w-full px-2 py-2 rounded-control hover:bg-white/5 transition-colors"
        >
          <Avatar user={user} size="sm" />
          <span className="flex-1 text-left text-[13.5px] font-medium text-text-dark-primary truncate">
