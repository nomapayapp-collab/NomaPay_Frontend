...
export default function Dashboard() {
  ...
  const [exchangeRatesRef, exchangeRatesHeight] = useElementHeight<HTMLDivElement>();
  const recentMovementsHeight = isDesktop ? exchangeRatesHeight : null;
      ...
      <div className="flex flex-col gap-5 lg:gap-6">
        ...
        <div className="flex flex-col gap-5 lg:grid lg:grid-cols-3 lg:gap-6 lg:items-start">
          <div className="lg:col-span-2">
            <RecentMovements maxHeight={recentMovementsHeight} />
          </div>

          <div className="hidden lg:block" ref={exchangeRatesRef}>
            <ExchangeRatesList />
          </div>
        </div>
      </div>
