    ...
    <div className="flex justify-around py-2 lg:justify-start lg:gap-4">
      {ACTIONS.map(({ label, icon: Icon, to, color }) => (
        <button
          ...
          type="button"
          onClick={() => navigate(to)}
          className="flex flex-col items-center gap-2 text-text-light-secondary dark:text-text-dark-secondary hover:text-text-light-primary dark:hover:text-text-dark-primary
