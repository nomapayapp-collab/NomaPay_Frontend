const STEPS = [
  {
    ...
    description: "Registrate gratis en minutos y empezá a disfrutar.",
    caption: "< 4 minutos",
  },
  {
    number: "02",
    title: "Cobrá global",
    description:
      "Compartí tu alias y recibí pagos de clientes o empresas de otros países, en la divisa en que te pagan.",
    caption: "Acreditación inmediata",
  },
  {
    number: "03",
    title: "Usá tu plata",
    description:
      "Convertí, transferí o gastá tu dinero desde un solo lugar, con la tasa a la vista antes de confirmar.",
    caption: "Al instante",
  },
];
